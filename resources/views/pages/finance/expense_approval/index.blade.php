...
@section('breadcrumb-item-active', 'Approval')
@section('content')
<!-- [ Main Content ] start -->
...
<div class="modal fade" id="approvalModel" tabindex="-1" role="dialog" aria-labelledby="approvalModelLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="submitFormBtnApproval" method="POST" action="{{route('finance.expense.approval.approved')}}">
                    @csrf
...
<div class="modal fade" id="rejectModel" tabindex="-1" role="dialog" aria-labelledby="rejectModelLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="submitFormBtnReject" method="POST" action="{{route('finance.expense.approval.rejected')}}">
                    @csrf
...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            , processing: true
            , serverSide: true
            // , ajax: "{{ route('finance.expense.approval.index')}}",

            ,ajax: {
                    url: "{{ route('finance.expense.approval.index')}}",
                    data: function(d) {
