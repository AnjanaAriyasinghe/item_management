...
@section('breadcrumb-item-active', 'Approved List')
@section('content')
<!-- [ Main Content ] start -->
...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            , processing: true
            , serverSide: true
            // , ajax: "{{ route('finance.expense.approval.approved_list')}}"

            ,ajax: {
                    url: "{{ route('finance.expense.approval.approved_list')}}",
                    data: function(d) {
