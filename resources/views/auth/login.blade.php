        ...
        <div class="card my-5">
            <div class="card-body">
                <div class="text-center">
                    <img src="https://vitalone.lk/images/resources/logo-dark.png" width="40%">
                    <h4 class="f-w-500 mb-2 mt-2">Login with your email</h4>
                </div>
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="form-group mb-3">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"  required autocomplete="email" autofocus id="floatingInput" placeholder="Email Address">
                        @error('email')
