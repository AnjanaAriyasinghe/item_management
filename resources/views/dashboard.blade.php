...
<!-- [ Main Content ] start -->
<div class="row">
    <!-- Row 1: Operations & Sales -->
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 bg-brand-color-1 text-white overflow-hidden">
            <div class="card-body">
                <i class="ph-duotone ph-currency-circle-dollar text-white opacity-50" style="position:absolute; right: -20px; top: -20px; font-size: 100px;"></i>
                <h5 class="mb-4 text-white">Total Sales</h5>
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0 text-white">Rs. <span id='total_sales_amount' class="ms-2">0</span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
                <i class="ph-duotone ph-users opacity-10" style="position:absolute; right: -20px; top: -20px; font-size: 100px; color:#555;"></i>
                <h5 class="mb-4">Total Customers</h5>
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0"><span id='total_customers' class="badge bg-light-info ms-2">0</span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
                <i class="ph-duotone ph-package opacity-10" style="position:absolute; right: -20px; top: -20px; font-size: 100px; color:#555;"></i>
                <h5 class="mb-4">Total Items Tracked</h5>
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0"><span id='total_items' class="badge bg-light-primary ms-2">0</span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 bg-brand-color-2 text-white overflow-hidden">
            <div class="card-body">
                <i class="ph-duotone ph-warning-circle text-white opacity-50" style="position:absolute; right: -20px; top: -20px; font-size: 100px;"></i>
                <h5 class="mb-4 text-white">Low Stock Alerts</h5>
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0 text-white"><span id='low_stock_items' class="badge bg-light-warning ms-2">0</span> Items</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 overflow-hidden ">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0"><span id='expens_categories'
                            class="badge bg-light-primary ms-2">0</span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 overflow-hidden ">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0"><span id='expens_sub_categories'
                            class="badge bg-light-primary ms-2">0</span></h3>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="card statistics-card-1 overflow-hidden ">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3">
                    <h3 class="f-w-300 d-flex align-items-center m-b-0"><span id='venndors'
                            class="badge bg-light-primary ms-2">0</span></h3>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-12">
        <div class="card statistics-card-1 overflow-hidden  bg-brand-color-3">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-3">
                    <h3 class="text-white f-w-300 d-flex align-items-center m-b-0"><span id='bankAccounts'
                            class="badge bg-light-primary ms-2">0</span></h3>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-2">
                        <select name="search_company_id" id="search_company_id"
                            class="form-control search_company_id form-control-custom-select">
                            <option value=""></option>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mb-0" id="monthly-div">
                        <select name="monthly" id="monthly" class="form-control monthly form-control-custom-select">
                            ...
                            <option value="{{ $value }}" @if($value == $currentMonth) selected @endIf>{{ $value }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-4 mb-0" style="display:none;" id="daily-div">
                        <input class="mb-0 form-control form-control-custom" type="date" id="daily" name="daily"
                            onchange="dateClicked()" placeholder="">
                    </div>
                </div>
                <div class="container">
                    <h2>Expenses</h2>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="card statistics-card-1 overflow-hidden">
            <div class="card-body">
                <div class="row">
                    <div class="form-group col-md-12 mb-2">
                        <select name="search_payments_company_id" id="search_payments_company_id"
                            class="form-control search_payments_company_id form-control-custom-select">
                            <option value=""></option>
                            <option value="all">All</option>
                            @foreach ($companies as $company)
                                {{-- <option value="{{ $company->id }}">{{ $company->name }}</option> --}}
                ...
                <div class="row">
                    <div class="form-group col-md-4 mb-0">
                        <select name="year_payment" id="year_payment"
                            class="form-control year_payment form-control-custom-select">
                            <option value="2025">2025</option>
                            <option value="2024">2024</option>
                            <option value="2026">2026</option>
                            <option value="2027">2027</option>
                    ...
                    <div class="form-group col-md-4 mb-0">
                        <select name="selector_payment" id="selector_payment"
                            class="form-control selector_payment form-control-custom-select">
                            <option value="monthly">Monthly</option>
                            <option value="daily">Daily</option>
                        </select>
                    </div>
                    <div class="form-group col-md-4 mb-0" id="monthly-div_payment">
                        <select name="monthly_payment" id="monthly_payment"
                            class="form-control monthly_payment form-control-custom-select">
                            <option value="">--select month--</option>
                            @foreach($months as $value)
                            <option value="{{ $value }}" @if($value == $currentMonth) selected @endIf>{{ $value }}
                            </option>
                    ...
                    <div class="form-group col-md-4 mb-0" style="display:none;" id="daily-div_payment">
                        <input class="mb-0 form-control form-control-custom" type="date" id="daily_payment"
                            name="daily_payment" onchange="dateClicked_payment()" placeholder="">
                    </div>
                </div>
                <div class="container">
                    <h2>Payments</h2>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4 ">
                                        <div class="form-group form-floating mb-0">
                                            <select name="search_company_id_recent_payments"
                                                id="search_company_id_recent_payments"
                                                class="form-control search_company_id_recent_payments form-control-custom-select">
                                                <option value=""></option>
                                                <option value="all">All</option>
                                                @foreach ($companies as $company)
                                                    {{-- <option value="{{ $company->id }}">{{ $company->name }}</option>
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                , success: function (response) {
                    ...
                    // New metrics
                    var totalSalesFmt = Number(response.data.total_sales_amount || 0).toLocaleString('en-US', {minimumFractionDigits: 2});
                    $('#total_sales_amount').text(totalSalesFmt);
                    $('#total_customers').text(response.data.total_customers);
                    $('#total_items').text(response.data.total_items);
                    $('#low_stock_items').text(response.data.low_stock_items);
                }
                , error: function (xhr) {
